...
const viewsData = [
  {
    imageSource: require('../img/roasted-turkey.png'),
    text: 'Granny Recipe',
  },
  {
    imageSource: require('../img/spaghetti.png'),
    text: 'Traditional Food',
  },
];

const RecipeGrannyHeaderList = () => {
...
export default RecipeGrannyHeaderList;
