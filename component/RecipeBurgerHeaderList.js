...
const viewsData = [
  {
    imageSource: require('../img/pizza-slice.png'),
    text: 'Pizza Food',
  },
  {
    imageSource: require('../img/hamburger.png'),
    text: 'Hamburger Food',
  },
];

const RecipeBurgerHeaderList = () => {
...
>
    ...
    >
      ...
      <Text style={styles.homeTitle}>
        ...
        <Text style={styles.homeSubtitle}>Enjoy delicious bistro meals</Text>
      </View>
...
export default RecipeBurgerHeaderList;
