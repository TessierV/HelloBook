...
const viewsData = [
  {
    imageSource: require('../img/pizza.png'),
    text: "Burgers Gourmets à Déguster",
  },
  {
    imageSource: require('../img/pizza.png'),
    text: "Pizza Faits Maison",
  },
  {
    imageSource: require('../img/pizza.png'),
    text: "Succombez à la Magie de la Street-Food",
  },
];

const StreetFoodRecipeContainer = ({ recipes, likedRecipes, onToggleLike }) => {
  ...
  const BurgerRecipes = recipes.filter((recipe) => recipe.course.includes('Burger'));
  const FlammekuecheRecipe = recipes.filter((recipe) => recipe.course.includes('Flammekueche'));
  const PizzaRecipes = recipes.filter((recipe) => recipe.course.includes('Pizza'));
      ...
      >
        <View style={styles.container}>
          ...
          <View style={styles.centerColumn}>
            <Text style={styles.homeTitle}>Festin de Rue</Text>
            <Text style={styles.homeSubtitle}>
              {currentData.text.split(' ').map((word, index) => (
                <Text
                  ...
                  style={[
                    styles.homeText,
                    (word === 'Maison' || word === 'Succombez' || word === 'Gourmets' ) && { color: colors.primaryColors, fontWeight: 'bold' },
                  ]}
                >
                  {word}{' '}
                </Text>
  ...
  <RecipeList
    ...
    />
  <RecipeList
    recipes={PizzaAndFlammekuecheRecipes}
    likedRecipes={likedRecipes}
    onToggleLike={onToggleLike}
    categoryTitle="Pizza  & Flammekueche"
  />
  </>
)}
    </>
...
export default StreetFoodRecipeContainer;
