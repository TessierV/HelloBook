...
const viewsData = [
  {
    imageSource: require('../img/1.png'),
    text: 'Japanese Food',
  },
  {
    imageSource: require('../img/2.png'),
    text: 'Korean Food',
  },
  {
    imageSource: require('../img/3.png'),
    text: 'Indian Food',
  },
];

const RecipeWorldHeaderList = () => {
      ...
      <Text style={styles.homeTitle}>
          {currentData.text.split(' ').map((word, index) => (
            <Text
              ...
              style={[
                styles.homeText,
                word === 'Indian' || word === 'Japanese' || word === 'Korean'
        ...
        <Text style={styles.homeSubtitle}>Enjoy delicious meals from Asia</Text>
      </View>
...
export default RecipeWorldHeaderList;
